        ...
        <div class="card" id="calc-modules-card">
            ...
            <div class="card-body">
                ...
                <div class="row g-2" id="calc-modules">
                    ...
                    <div class="col-md-12"><label class="d-flex align-items-center gap-2 p-2 rounded border calc-module" data-setup="400" data-yearly="600" data-flat="1"><input type="checkbox" class="form-check-input calc-module-cb"><i class="bi bi-bank text-info"></i><span class="flex-grow-1">Opłaty federacyjne</span><span class="text-muted small">1000 PLN pierwszy rok, 600 PLN kolejne lata</span></label></div>
