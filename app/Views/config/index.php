...
<div class="row g-3 mb-4">
    ...
    <div class="col-auto">
        <a href="<?= url('config/discipline-classes') ?>" class="btn btn-outline-secondary btn-sm <?= str_contains($_SERVER['REQUEST_URI'],'/discipline-classes') ? 'active':'' ?>">
            <i class="bi bi-trophy"></i> Klasy sportowe
        </a>
    </div>
    <div class="col-auto">
        <a href="<?= url('config/member-types') ?>" class="btn btn-outline-secondary btn-sm <?= str_contains($_SERVER['REQUEST_URI'],'/member-types') ? 'active':'' ?>">
            <i class="bi bi-person-badge"></i> Typy członkostwa
        </a>
    </div>
    <div class="col-auto">
